...
class FormService {
  ...
  /**
     ...
     * @return {FormData} Objeto com dados normalizados e validados
     */
  ...
  /**
     ...
     * @return {Object} Corpo da requisição para People.People.createContact()
     */
  ...
  /**
     ...
     * @return {{ valid: boolean, missingKeys: string[] }}
     */
