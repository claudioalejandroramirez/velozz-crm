...
class AppConfig {
    ...
    getTagAlerta() { return this.get('NOME_TAG_ALERTA'); }
    getTagNovoTelefone() { return this.get('NOME_TAG_NOVO_TELEFONE'); }
    getTagNovoEmail() { return this.get('NOME_TAG_NOVO_EMAIL'); }
    getTagExpiryDays() { return parseInt(this.get('TAG_EXPIRY_DIAS'), 10); }
