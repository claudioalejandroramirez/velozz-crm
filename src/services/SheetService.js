...
class SheetService {
  ...
  /**
     ...
     * @return {number} Índice 1-based da coluna
  ...
  /**
     ...
     * @return {{ valid: boolean, missing: string[], found: string[] }}
     */
  ...
  /**
     ...
     * @return {Object.<string, *>} Mapa { headerName → valor }
     */
  ...
  /**
     ...
     * @return {number|null} Número da linha (1-based) ou null se não encontrado
     */
