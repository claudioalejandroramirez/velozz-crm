...
class Formatter {
  /**
     ...
     * @return {string} Telefone formatado ou raw se tamanho inválido
     */
  static phone(tel) {
    if (!tel) return '';
  ...
  /**
     ...
     * @return {string} Documento formatado, ou raw se não bater o padrão
     */
  ...
  /**
     ...
     * @return {string} E-mail em lowercase sem espaços
     */
